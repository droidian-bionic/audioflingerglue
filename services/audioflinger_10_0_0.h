...
public:
    ...
    virtual sp<media::IAudioRecord> createRecord(
    ...
    virtual status_t setMasterBalance(float balance) {
        return NO_ERROR;
    }

    virtual status_t getMasterBalance(float *balance) const {
        return NO_ERROR;
    }
